# Pretrained legal encoder

Candidate: `nlpaueb/legal-bert-base-uncased`, by the Athens University of
...
# Additional experimental encoder

`FacebookAI/roberta-base` is distributed under MIT, per its model card:
https://huggingface.co/FacebookAI/roberta-base . Preserve the upstream license

...
function Header({ active, onNavigate }: { active: string; onNavigate: (view: 'review' | 'sources') => void }) {
  return (
    <header className="app-header">
      <Brand />
      <nav aria-label="Primary navigation">
        <button aria-current={active === 'review' ? 'page' : undefined} className={active === 'review' ? 'active' : ''} onClick={() => onNavigate('review')}>Review</button>
        <button aria-current={active === 'sources' ? 'page' : undefined} className={active === 'sources' ? 'active' : ''} onClick={() => onNavigate('sources')}>Source library</button>
      </nav>

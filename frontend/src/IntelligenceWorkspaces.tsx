...
import {
  ArrowRight, CheckCircle2, CircleAlert, Database, FileOutput,
...
function OfflineNotice() {
  return <div className="offline-notice" role="note"><ShieldCheck /><div><strong>Live API required</strong><p>Offline demo mode is active. These screens remain available for review, but no intelligence, entity, or status results are fabricated.</p></div></div>
}
